        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AliasName = table.Column<Guid>(type: "TEXT", nullable: true),
                    Path = table.Column<string>(type: "TEXT", nullable: true),
                    SizeByte = table.Column<long>(type: "INTEGER", nullable: false),
                    IsFileSaved = table.Column<bool>(type: "INTEGER", nullable: true),
